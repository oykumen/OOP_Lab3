...
System::Void Laba3::MyForm::button_load_Click(System::Object^ sender, System::EventArgs^ e)
{
...
System::Void Laba3::MyForm::button_add_Click(System::Object^ sender, System::EventArgs^ e)
{
...
System::Void Laba3::MyForm::button_delete_Click(System::Object^ sender, System::EventArgs^ e)
{
	if (dataGridView_Table->SelectedRows->Count != 1)
	{
		MessageBox::Show("Выберите одну строку!", "Внимание!");
...
System::Void Laba3::MyForm::button_update_Click(System::Object^ sender, System::EventArgs^ e)
{
	if (dataGridView_Table->SelectedRows->Count != 1)
	{
		MessageBox::Show("Выберите одну строку!", "Внимание!");
...
System::Void Laba3::MyForm::listBox_ChooseTable_SelectedIndexChanged(System::Object^ sender, System::EventArgs^ e)
{
